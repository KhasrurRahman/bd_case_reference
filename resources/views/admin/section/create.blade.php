                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line" {{ $errors->has('civil') ? 'focused error' : '' }}>
                                    ...
                                    <select name="act_id" class="form-control show-tick selectpicker" data-live-search="true" multiple data-max-options="1">
                                        @foreach($act as $acts)
                                            <option value="{{ $acts->id }}">
                                                {{ $acts->name }}
                                            </option>
                                        @endforeach
                                    </select>
