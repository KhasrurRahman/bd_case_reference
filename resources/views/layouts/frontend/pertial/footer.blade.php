...
<footer class="footer">
        ...
        <div class="container">
            <div class="col-md-9 col-sm-12">
                <div class="footer-widget">
                    <h3 class="widgettitle widget-title">About the Website</h3>
                    <div class="textwidget">
                        <p>309(2nd Floor),Ibrahim Mansion, 11, Purana Paltan, Dhaka-1000</p>
                        <p><strong>Email:</strong> easinsikder@bdcasereference.com</p>
                        <p><strong>Call:</strong> <a href="tel:+88015-11164360"> +88015-11164360</a></p>
    ...
    <div class="row copyright">
        <div class="container">
            <p> Copyright © BD CASE REFERENCE </p><br>
            <h4 style="color: #FFFFFF;margin-top: 0px">Supported by <a href="http://ratin-portfolio.com" target="_blank">Md.khasrur Rahman</a></h4>
        </div>
    </div>
</footer>
